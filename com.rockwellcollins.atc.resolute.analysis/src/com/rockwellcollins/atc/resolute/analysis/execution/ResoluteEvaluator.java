...
public class ResoluteEvaluator extends ResoluteSwitch<ResoluteValue> {
	...
	@Override
	public ResoluteValue caseEvidenceExpr(EvidenceExpr expr) {
		return TRUE;
	}
...
//	}
	...
	@Override
	public ResoluteValue caseClaimDefeater(ClaimDefeater object) {
		return varStack.peek().get(object);
	}

	@Override
	public ResoluteValue caseClaimGuarantee(ClaimGuarantee object) {
		return varStack.peek().get(object);
	}
