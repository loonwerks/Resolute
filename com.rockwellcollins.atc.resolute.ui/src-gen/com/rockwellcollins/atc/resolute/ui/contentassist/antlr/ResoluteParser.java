		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getClaimAssumptionAccess().getAlternatives_0(), "rule__ClaimAssumption__Alternatives_0");
					...
					put(grammarAccess.getAtomicExprAccess().getLintStmtAssignment_12_1(), "rule__AtomicExpr__LintStmtAssignment_12_1");
