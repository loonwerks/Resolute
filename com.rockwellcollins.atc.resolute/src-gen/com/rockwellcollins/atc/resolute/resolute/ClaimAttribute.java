 ...
 * @generated
 */
public interface ClaimAttribute extends EObject
{
  /**
   ...
   * @see #setName(String)
   * @see com.rockwellcollins.atc.resolute.resolute.ResolutePackage#getClaimAttribute_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link com.rockwellcollins.atc.resolute.resolute.ClaimAttribute#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
