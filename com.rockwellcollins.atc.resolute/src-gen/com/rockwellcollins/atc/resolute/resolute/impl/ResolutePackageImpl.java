...
public class ResolutePackageImpl extends EPackageImpl implements ResolutePackage
{
   ...
   * @generated
   */
  private EClass claimUsageDomainEClass = null;
   ...
   * @generated
   */
  private EClass claimRationaleEClass = null;
   ...
   * @generated
   */
  private EClass claimGuaranteeEClass = null;
   ...
   * @generated
   */
  private EClass objectExprEClass = null;
   ...
   */
  @Override
  public EAttribute getFunctionDefinition_DefType()
  {
   ...
   */
  @Override
  public EClass getClaimUsageDomain()
  {
    return claimUsageDomainEClass;
  }
   ...
   */
  @Override
  public EReference getClaimUsageDomain_Val()
  {
    return (EReference)claimUsageDomainEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EClass getClaimRationale()
  {
    return claimRationaleEClass;
  }
   ...
   */
  @Override
  public EReference getClaimRationale_Val()
  {
    return (EReference)claimRationaleEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getClaimAssumption_Expr()
  {
   ...
   */
  @Override
  public EClass getClaimGuarantee()
  {
    return claimGuaranteeEClass;
  }
   ...
   */
  @Override
  public EReference getClaimGuarantee_Expr()
  {
    return (EReference)claimGuaranteeEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EAttribute getResultExpr_Result()
  {
    return (EAttribute)resultExprEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EClass getObjectExpr()
  {
    return objectExprEClass;
  }
   ...
   */
  @Override
  public EAttribute getObjectExpr_Expr()
  {
    return (EAttribute)objectExprEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(functionDefinitionEClass, FUNCTION_DEFINITION__DEF_TYPE);
    ...
    claimUsageDomainEClass = createEClass(CLAIM_USAGE_DOMAIN);
    createEReference(claimUsageDomainEClass, CLAIM_USAGE_DOMAIN__VAL);
    ...
    createEReference(claimAssumptionEClass, CLAIM_ASSUMPTION__EXPR);

    claimStrategyEClass = createEClass(CLAIM_STRATEGY);
    createEReference(claimStrategyEClass, CLAIM_STRATEGY__VAL);

    claimGuaranteeEClass = createEClass(CLAIM_GUARANTEE);
    createEReference(claimGuaranteeEClass, CLAIM_GUARANTEE__EXPR);
    ...
    createEAttribute(resultExprEClass, RESULT_EXPR__RESULT);
    ...
    objectExprEClass = createEClass(OBJECT_EXPR);
    createEAttribute(objectExprEClass, OBJECT_EXPR__EXPR);
  ...
  public void initializePackageContents()
  {
    ...
    claimContextEClass.getESuperTypes().add(theAadl2Package.getNamedElement());
    ...
    claimStrategyEClass.getESuperTypes().add(theAadl2Package.getNamedElement());
    claimGuaranteeEClass.getESuperTypes().add(theAadl2Package.getNamedElement());
    ...
    resultExprEClass.getESuperTypes().add(this.getExpr());
    ...
    objectExprEClass.getESuperTypes().add(this.getExpr());
    letExprEClass.getESuperTypes().add(this.getExpr());
    undevelopedExprEClass.getESuperTypes().add(this.getExpr());
    evidenceExprEClass.getESuperTypes().add(this.getExpr());
    ...
    initEAttribute(getFunctionDefinition_DefType(), theEcorePackage.getEString(), "defType", null, 0, 1, FunctionDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(claimUsageDomainEClass, ClaimUsageDomain.class, "ClaimUsageDomain", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getClaimUsageDomain_Val(), theAadl2Package.getStringLiteral(), null, "val", null, 0, 1, ClaimUsageDomain.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getClaimAssumption_Expr(), this.getExpr(), null, "expr", null, 0, 1, ClaimAssumption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(claimGuaranteeEClass, ClaimGuarantee.class, "ClaimGuarantee", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getClaimGuarantee_Expr(), this.getExpr(), null, "expr", null, 0, 1, ClaimGuarantee.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getClaimBody_Attributes(), theAadl2Package.getNamedElement(), null, "attributes", null, 0, -1, ClaimBody.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getResultExpr_Result(), theEcorePackage.getEString(), "result", null, 0, 1, ResultExpr.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(objectExprEClass, ObjectExpr.class, "ObjectExpr", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getObjectExpr_Expr(), theEcorePackage.getEString(), "expr", null, 0, 1, ObjectExpr.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
